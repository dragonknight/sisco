...
/*-------------------------------------------------------------------------------------------------------------------------------- 
	funci贸n: Men煤 administrador
	Descripci贸n: Funci贸n que muestra el men煤 del usuario Administrador (previa autenticaci贸n en el sistema).
...
/*-------------------------------------------------------------------------------------------------------------------------------- 
	funci贸n: Men煤 Recepcionista
	Descripci贸n: Funci贸n que muestra el men煤 de usuario con acceso recepcionista.
	Desarrollador: Carlos Castillo, menu de http://www.dynamicdrive.com 
	Modificado: 
...
/*-------------------------------------------------------------------------------------------------------------------------------- 
	funci贸n: Men煤 completo
	Descripci贸n:Funci贸n que muestra el men煤 de usuario completo en el sistema (secretario general o coordinadora).
	Desarrollador: Carlos Castillo, menu de http://www.dynamicdrive.com 
	Modificado: 
...
/*-------------------------------------------------------------------------------------------------------------------------------- 
	funci贸n: Men煤 Asistente o secretaria
	Descripci贸n:Funci贸n que muestra el men煤 de usuario con acceso asistente o secretaria
	Desarrollador: Carlos Castillo, menu de http://www.dynamicdrive.com 
	Modificado: 
...
function menuEAudiecias()
	{
		...
		echo '
				...
				<ul id="ddsubmenu1" class="ddsubmenustyle">
					...
					<li><a href="#">Entrantes:</a>
						<ul>
							<li><a href="../Paginas/entrantes.php" target="contenido">Nueva Comunicaci贸n</a></li>
		...
		echo '
							...
							<ul id="ddsubmenu1" class="ddsubmenustyle">
								...
								<li><a href="#">Salientes:</a>
									<ul>
										<li><a href="../Paginas/salientes.php" target="contenido">Nueva Comunicaci贸n</a></li>
										<li><a href="../Paginas/.php" target="contenido">Redirecci贸n</a></li>
									</ul>
								</li>
							</ul>
