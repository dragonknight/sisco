...
?> 			
		<div id="persona">
			...
			<div id="usrCol2">
				<input type="text" name="Apellidos" id="Apellidos" size="20" onkeypress="return validaTextos(event);" onchange="validaTextComp(this.id,this.value)"> <br />
			</div>
			<div id="usrCol3">
				Nombres:
			</div>
			<div id="usrCol4">
				<input type="text" name="Nombres" id="Nombres" size="20" onkeypress="return validaTextos(event);" onchange="validaTextComp(this.id, this.value)"> <br />
			</div>
			<div id="usrCol1">
				Cédula:
			</div>
			<div id="usrCol2">
				<input type="text" name="Cedula" id="Cedula" value="" size="20" onkeypress="return soloNumeros(event);" onchange="validaCedula(this.id, this.value)"> <br />
			</div>
			<div id="usrCol3">
				Sexo:
			</div>
			...
			<div id="usrCol2">
				<input type="text" name="Telefono" id="Telefono" size="20" onkeypress="return soloNumeros(event);" onchange="validaNumeros(this.id, this.value)"> <br />
			</div>
			<div id="usrCol3">
				Correo:
			</div>
...
?> 			
		<div id="ente">
			...
			<div id="usrCol4">
				<input type="text" name="Telefono" id="Telefono" value="" size="20" onkeypress="return soloNumeros(event);" onchange="validaNumeros(this.id, this.value )"> <br />
			</div>
			<div id="usrCol1">
				Correo:
			</div>
