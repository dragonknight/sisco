...
?> 			
		<div id="persona">
			...
			<div id="usrCol2">
				<input type="text" name="Cedula" id="Cedula" value="" size="20" onchange="validaNoDupli(this.id, this.value)"> <br />
			</div>
			<div id="usrCol3">
				Sexo:
			</div>
...
?> 			
		<div id="ente">
			...
			<div id="usrCol2">
				<input type="text" name="Id" id="Id" value="" size="20" onchange="validaNoDupli(this.id, this.value)"> <br />
			</div>
			<div id="usrCol3">
				Nombre:
			</div>
...
?> 			
		<div id="usuario">
			...
			Usuario: <input type="text" name="usrLogin" id="usrLogin" size="20" onchange="validaNoDupli(this.id, this.value)"> <br />
			Contraseña: <input type="password" name="usrPassword" id="usrPassword" size="20" onchange="validaNoDupli(this.id, this.value)">					
		</div>
<?php
	}
?>